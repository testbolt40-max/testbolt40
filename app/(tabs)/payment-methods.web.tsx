...
export default function PaymentMethodsScreen() {
  ...
  const handleAddCreditCard = async () => {
    ...
    try {
      // Web version - simplified without Stripe integration
      Alert.alert(
        'Web Platform Notice',
        'Credit card processing is not available on the web platform. Please use the mobile app for full payment functionality.',
        [{ text: 'OK' }]
      );
      
      // For demo purposes, we'll still save the card info (without sensitive data)
      ...
      <Animated.View style={[styles.contentContainer, { opacity: fadeAnim }]}>
        <View style={styles.webNotice}>
          <Text style={styles.webNoticeText}>
            💡 For full payment processing, please use the mobile app
          </Text>
        </View>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.securityNote}>
                ...
                <Text style={styles.securityText}>
                  Web version - Limited functionality. Use mobile app for secure processing.
                </Text>
              </View>
              ...
              >
                <Text style={styles.addCardButtonText}>
                  {isProcessing ? 'Adding Card...' : 'Add Card (Demo)'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
